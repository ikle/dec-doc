...
NOTE: RA должен быть на 13-ом, а не 3-ем выводе.
...
*  8     — вход 17 разряда микроканала (!M17);
...
* 12     — вход/выход 16 разряда микроканала (!M16);
...
* 28..34 — входы 15..9 разрядов микроканала (!M15..M9);
* 35     — свободный;
* 36..43 — входы 8..1 разрядов микроканала (!M8..M1);
* 44     — вход/выход 0 разряда микроканала (!M0);
...
Ток потребления:
  — от источника питания U<sub>П2</sub> .................................. ≤ 8 мА
